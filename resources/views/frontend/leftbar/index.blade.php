		...
		<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="#"><i class="fa fa-edit" aria-hidden="true"></i><span class="menu-title" data-i18n="nav.page_layouts.main">About Details</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('about.index')}}" data-i18n="nav.page_layouts.1_column">Add About Details</a>
                    </li>
                    <li><a class="menu-item" href="{{route('about.index')}}" data-i18n="nav.page_layouts.1_column">All About Details</a>
                    </li>
                </ul>
            </li>
