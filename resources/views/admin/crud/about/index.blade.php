        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">About Details</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">About Details
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="col-md-6">
                                        <form action="{{route('about.save')}}" method="get">
                                            ...
                                            <div class="form-group">
                                                <h5>Enter About Detail Name
                                                    <span class="required">*</span>
                                                </h5>
                                                <div class="controls">
                                                    <input type="text" name="about_name" class="form-control" required=""  placeholder="Enter About Name" data-validation-required-message="This field is required" aria-invalid="false">
                                                    <div class="help-block"></div>
                                                </div>
                                                <p>
                                                    kindly add the <code>about</code> name you want to create
                                                </p>
                                            </div>

                                            <div class="form-group">
                                                <h5>Enter About Detail Description
                                                    <span class="required">*</span>
                                                </h5>
                                                <div class="controls">
                                                    <textarea class="form-control" name="about_description" rows="3" placeholder="Enter About Description" data-validation-required-message="This field is required" aria-invalid="false"></textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                                <p>
                                                    kindly add the <code>about detail</code> you want to create
                                                </p>
                                            </div>
