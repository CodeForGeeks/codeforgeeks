                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Technology
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="col-md-6">
                                        <form action="{{route('technology.save')}}" method="get">
                                            ...
                                            <div class="form-group">
                                                <h5>Enter Technology Name
                                                    <span class="required">*</span>
                                                </h5>
                                                <div class="controls">
                                                    <input type="text" name="technology_name" class="form-control" required=""  placeholder="Enter Technology Name" data-validation-required-message="This field is required" aria-invalid="false">
                                                    <div class="help-block"></div>
                                                </div>
                                                <p>
                                                    kindly add the <code>technology</code> name you want to create
                                                </p>
                                            </div>

                                            <div class="form-group">
                                                <h5>Enter Technology Description
                                                    <span class="required">*</span>
                                                </h5>
                                                <div class="controls">
                                                    <textarea class="form-control" name="technology_description" rows="3" placeholder="Enter Technology Description" data-validation-required-message="This field is required" aria-invalid="false"></textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                                <p>
                                                    kindly add the <code>technology description</code> you want to create
                                                </p>
                                            </div>
                                            <div class="form-group">
                                                <h5>Enter Technology Icon
                                                </h5>
                                                <div class="controls">
                                                    <input type="text" name="technology_icon" class="form-control" placeholder="Font Awesome Icon, For eg(fab fa-laravel)">
                                                    <div class="help-block"></div>
                                                </div>
                                                <p>
                                                    kindly add the <code>technology icon</code> if  you want to add
                                                </p>
                                            </div>
