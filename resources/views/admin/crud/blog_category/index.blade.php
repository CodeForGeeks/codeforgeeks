                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="col-md-6">
                                        <form action="{{route('blog_category.save')}}" method="POST">
                                            ...
                                            <div class="form-group">
                                                <h5>Enter Category Name
                                                    <span class="required">*</span>
                                                </h5>
                                                <div class="controls">
                                                    <input type="text" name="blog_category_name" class="form-control" required=""  placeholder="Enter Course Name" data-validation-required-message="This field is required" aria-invalid="false">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select class="form-control" id="basicSelect" name="blog_category_parent" >
                                                        <option value="">Select Option</option>
                                                        @foreach ($categories as $eachCategory)
                                                        <option value="{{$eachCategory->blog_category_id}}">{{$eachCategory->blog_category_name}}</option>
                                                        @endforeach
                                                        </select>
                                                    <div class="help-block"></div>
                                                </div>
